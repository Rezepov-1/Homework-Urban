...
# В русском языке окончания слов меняются (1 участник, 2 участника), пока что давайте не обращать
# на это внимания.
...
# Давайте разберем, как можно форматировать строки для указанных сценариев, используя %, .format(),
# и f-строки.
# Использование %
...
# 2 Время, за которое команда 2 решила задачи (team2_time):
team2_time = 18015.2
